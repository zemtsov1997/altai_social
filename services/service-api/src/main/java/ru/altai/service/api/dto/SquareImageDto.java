...
import ru.altai.service.api.model.ISquareImage;
...
public class SquareImageDto implements ISquareImage {
    ...
    public void setImage(byte[] image) {
        this.image = image;
        this.image50x50 = ImageUtil.scaleToSize(image, 50, 50);
        this.image100x100 = ImageUtil.scaleToSize(image, 100, 100);
        this.image200x200 = ImageUtil.scaleToSize(image, 200, 200);
        this.image300x300 = ImageUtil.scaleToSize(image, 300, 300);
        this.image400x400 = ImageUtil.scaleToSize(image, 400, 400);
        this.image500x500 = ImageUtil.scaleToSize(image, 500, 500);
    }

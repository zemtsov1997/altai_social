...
public interface IRectangleImage extends IAppImage {
    ...
    default void resize() {
        this.setImage200x800(ImageUtil.scaleToSize(this.getImage(), 200, 800));
        this.setImage400x1600(ImageUtil.scaleToSize(this.getImage(), 400, 1600));
        this.setImage600x2400(ImageUtil.scaleToSize(this.getImage(), 600, 2400));
        this.setImage800x3200(ImageUtil.scaleToSize(this.getImage(), 800, 3200));
        this.setImage1000x4000(ImageUtil.scaleToSize(this.getImage(), 1000, 4000));
    }
